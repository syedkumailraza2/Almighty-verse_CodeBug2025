...
const Deleteevent = () => {
  ...
  const deleteEvent = async (eventID) => {
    try {
      ...
      // Ensure state update is safe and does not cause rendering conflicts
            ...
            return (
              <div key={event._id} className="bg-white text-black rounded-lg p-4 relative">
                <div className="flex items-start">
                  ...
                  <button 
                    className="cursor-pointer absolute top-3 right-3 bg-red-600 hover:bg-red-700 text-white text-sm px-4 py-1 rounded-full"
